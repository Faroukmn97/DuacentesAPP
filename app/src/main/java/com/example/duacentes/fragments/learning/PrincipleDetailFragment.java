...
public class PrincipleDetailFragment extends Fragment {
    ...
    private final String[] descriptiondetailbyprinciple1 = {
    ...
    private final String[] descriptiondetailbyprinciple1voz = {
            "Los alumnos perciben y comprenden la información que se les presenta de diferentes maneras, ya sea por limitaciones sensoriales (visuales o auditivas), problemas de aprendizaje (dislexia), diferencias de idioma o culturales, entre otras. En otros casos, el procesamiento más rápido o eficiente de la información puede ser una cuestión de facilidad o preferencia percibida, ya sea que la información se presente a través de canales auditivos, visuales o impresos. Por eso, es importante que los docentes brinden opciones para adquirir o procesar información que permita el aprendizaje." +
                    "Para este primer componente del DUA, los docentes activan la red de reconocimiento del cerebro mediante la identificación de hechos, ideas y conceptos clave, principalmente asociados con el “contenido” del aprendizaje. Los docentes usan el conocimiento previo y los estilos de aprendizaje de los estudiantes para informar el contenido presentado en una variedad de formas apropiadas para las fortalezas de los estudiantes y para apoyar las conexiones entre la información nueva y la experiencia previa.",

            "La premisa del DUA es que no existe una mejor manera de actuar y expresarlo para todos los alumnos. Existen grandes diferencias en la forma en que procesan e interactúan con la información en situaciones de aprendizaje y expresan lo que están aprendiendo, lo que puede deberse a sus características o preferencias personales, o barreras derivadas de un conocimiento insuficiente del idioma, problemas de movimiento, limitaciones de memoria, etc." +
                    "El segundo componente, medios múltiples de expresión, implica la activación de la red estratégica del cerebro asociada principalmente con el aprendizaje del “cómo”. Es útil para planificar y ejecutar acciones y respuestas a la información proporcionada. Al brindarles a los estudiantes múltiples formas de demostrar lo que saben, los maestros les brindan opciones para comunicar su comprensión y dominio de las tareas académicas.",

            "El afecto representa un elemento crucial para el aprendizaje, y los alumnos difieren notablemente en las formas en que pueden estar comprometidos o motivados para aprender. Esta diversidad en la motivación puede tener su origen en factores de tipo neurológico, cultural, interés personal, conocimientos o experiencias, previas. " +
                    "Así como algunas personas están motivadas para trabajar en equipo, otras prefieren trabajar individualmente. En algunos casos, les inspira cosas nuevas; en otros, les genera incertidumbre o inseguridades y prefieren la rutina. Como señala el CAST, no existe un método único que capte el interés o el compromiso de todos los estudiantes en todas las situaciones. Para hacer frente a esta variabilidad en los entornos educativos, es importante ofrecer opciones que permitan diferentes formas de participar en el aprendizaje." +
                    "El tercer componente, medios múltiples de implicación, implica el “por qué” del aprendizaje y está relacionado con la red emocional del cerebro. La red ayuda a dar sentido a porqué los alumnos actúan sobre la información de cierta manera. Para involucrar a los estudiantes, los maestros conectan el aprendizaje con la vida real fomentando sus intereses y motivándolos. Este componente también incluye interacciones sociales con compañeros y el entorno social que los alumnos disfrutan mientras estudian."
    };
    ...
    private final int[] imgprinciplespautas = {
    ...
    private final String[] descriptiondetailbyprinciple2 = {
    ...
    private final String[] descriptiondetailbyprinciple2voz = {
            "Los medios de representación se enfocan en el “¿QUÉ se aprende?”, y para aquello, se tiene un conjunto de estrategias que son tres pautas que se pueden utilizar en la práctica docente con la finalidad de lograr currículos accesibles.",

            "Los medios de acción y expresión se enfocan en el “¿CÓMO se aprende?”, para llevar a cabo esta área de acción y expresión, de la misma forma que el primer bloque del DUA, se tiene un conjunto de estrategias que son tres pautas.",

            "Los medios de implicación se enfocan en el “¿POR QUÉ se aprende?”. De igual forma que el primer y segundo componente del DUA, contiene un conjunto de estrategias que son tres pautas."
    };
        ...
        if(object!=null){
            ...
            btnvoz.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ttsManager.initQueue(descriptiondetailbyprinciple1voz[principleModel.getIdprinciple() -1]);
                }
            });
            ...
            btnvoz2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ttsManager.initQueue(descriptiondetailbyprinciple2voz[principleModel.getIdprinciple() -1]);
                }
            });
